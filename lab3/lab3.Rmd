...
urls <- c("Strawberrysingh.com", "Quanser.com", "Juicybomb.com","Obeo.com","Circlepix.com","Alterlinks.com","Sigchi.org","Xynergy.com","Es.com","Immersion.com", "Moove.com", "Dxstudio.com","Pixtra.com","Ocean.lv")
...
```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Strawberrysingh.com")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Quanser.com")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Juicybomb.com")
```
...
```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Circlepix.com")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Alterlinks.com")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Sigchi.org")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Xynergy.com")
```
...
```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Digitalspace.com")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Immersion.com")
```
...
```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Dxstudio.com")
```

```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Pixtra.com")
```
